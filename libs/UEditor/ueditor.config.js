...
const toolbars = require('./config/toolbar');
const filterTxtRules = require('./config/filterTxtRules');
const configfn = require('./config/configfn');
const whitList = require('./config/whitlist');
